...
-- CS 342, Spring, 2015
-- kvlinden
--Modified by Andrew Groenewold
--Spring, 2017
--For lab exercise 2.1
...
--Ex 2.1.a:
--Try to repeat a primary key
--INSERT INTO Movie VALUES (2,'SpaceJam',1995,9.9,2222);

--Try to use use a null primary key
--INSERT INTO Movie VALUES (NULL,'SpaceJam',1995,9.9,2222);

--Try to violate a check constrain
--INSERT INTO Movie VALUES (3,'SpaceJam',1895,9.9,2222);

--Try to violate a datatype constraint
--INSERT INTO Movie VALUES (3,'SpaceJam',1895,'infinity',2222);

--Try to use a negative score
INSERT INTO Movie VALUES (3,'Not SpaceJam',1995,-5,2222);
